...
@section('content')
    @include('users.partials.header', [
        ...
        'description' => __('Edita tu perfil, cambia tu contraseña y obtén información relevante de tu usuario.'),
        'class' => 'col-lg-7'
    ])   
                ...
                <div class="card card-profile shadow">
                    ...
                    <div class="card-body pt-0 pt-md-4">
                            ...
                            <div class="col">
                                <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                                    <div>
                                        ...
                                        <span class="description">{{ __('Lecciones') }}</span>
                                    </div>
                                    <div>
                                        <span class="heading">10</span>
                                        <span class="description">{{ __('Upvotes') }}</span>
                                    </div>
                                    <div>
                        ...
                        <div class="text-center">
                            <h3>
                                {{ auth()->user()->name }}<span class="font-weight-light">, edad</span>
                            </h3>
                        ...
                        <form method="post" action="{{ route('profile.update') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="description" id="input-age" class="form-control form-control-alternative{{ $errors->has('description') ? ' is-invalid' : '' }}" placeholder="{{ __('Descripción') }}" value="{{ old('description', auth()->user()->description) }}">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-success mt-4">{{ __('Guardarss') }}</button>
                                </div>
                            </div>
                        </form>
                        <hr class="my-4" />
